...
img_bullet = [r"Assets\bullet.png", r'Assets\ShotGun_bullet.png', r"Assets\star_bullet.png",r"Assets\shot_gun_bullet.png"]
boxes = [r"Assets\ShotGun_Bullet_box.png", r"Assets\star_box.png", r"Assets/size_box.png", r"Assets\Box_shotgun.png"]
...
class Player(GameSprite):
    ...
    def __init__(self, image, width, height, x, y):
        ...
        self.current_bullet = "standart"

        self.upgrade_timer = 0

    def update(self):
        keys = key.get_pressed()
        if self.current_bullet != "standart":
...
class Bullet(GameSprite):
    def __init__(self, image, width, height, player):
        ...
        if self.bullet == "standart":
            self.speed = 15
            self.image = transform.scale(image.load(os.path.join(r"Assets\bullet.png")), (width, height))

        elif self.bullet == "shot_gun":
            self.speed = 5
            self.image = transform.scale(image.load(os.path.join(r'Assets\ShotGun_bullet.png')), (width, height))

        elif self.bullet == "star":
            self.speed = 50
            self.image = transform.scale(image.load(os.path.join(r"Assets\star_bullet.png")), (width, height))
...
class Power_box(GameSprite):
    ...
    def update(self):
        ...
        for c in collides:
            ship.current_bullet = self.type
        if self.rect.y > 500:
            self.kill()



box_classes = [Power_box(r"Assets\ShotGun_Bullet_box.png",40,40,0,0,"shot_gun"),
               Power_box(r"Assets\star_box.png",40,40,0,0,"star"),
               Power_box(r"Assets\size_box.png",40,40,0,0,"size"),
               Power_box(r"Assets\Electric_box.png",40,40,0,0,"electric")]
...
while run:
    ...
    if not finish:
        ...
        if timer_1 <= 5:
            ...
            type = randint(0, len(boxes) - 1)
            box = Power_box(boxes[type], 40, 40, randint(40, 640), -20, type)
            power_boxes.add(box)
